...
import algonquin.cst2335.myfinalproject.aviation.custom.RowHolder;

/**
 * This file will serve as the adapter for
 * populating flight data into the RecyclerView.
 */
public class FlightListAdapter extends RecyclerView.Adapter<RowHolder.FightsViewHolder>{
